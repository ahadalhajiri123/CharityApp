...
//        getSupportActionBar().setTitle("Sign Up");
        ...
        btnSignUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                progressDialog.show();
                saveData( etName.getText().toString(),etEmail.getText().toString(),etPassword.getText().toString());
    ...
    private void saveData(String name, final String email,String password) {
